...
#include "auv_msgs_ros2/srv/control_command.hpp"
#include "auv_msgs_ros2/msg/pose_stamped.hpp"
...
private:
    ...
    rclcpp::Client<auv_msgs_ros2::srv::ControlCommand>::SharedPtr client_;
    rclcpp::Subscription<sensor_msgs::msg::Joy>::SharedPtr joy_subscription_;

    rclcpp::Publisher<auv_msgs_ros2::msg::PoseStamped>::SharedPtr pose_goal_publisher_;
    rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr velocity_desired_publisher_;
    rclcpp::TimerBase::SharedPtr fsm_timer_;
    rclcpp::Subscription<auv_msgs_ros2::msg::PoseStamped>::SharedPtr pose_actual_subscriber_;
    ...
    rclcpp::Service<auv_msgs_ros2::srv::ControlCommand>::SharedPtr control_command_service_;
    ...
    void pose_actual_callback(const auv_msgs_ros2::msg::PoseStamped::SharedPtr msg);
    ...
    void handleControlCommand(const std::shared_ptr<auv_msgs_ros2::srv::ControlCommand::Request> request, std::shared_ptr<auv_msgs_ros2::srv::ControlCommand::Response> response);
};
